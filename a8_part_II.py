...
def get_birth_date(name: str) -> str:
    ...
    print(infobox_text)
    # TODO: fill this in
    pattern = "Born\S+\s\S+\s\S+\((?P<birth>([\d-]+))"
    error_text = (
...
if __name__ == "__main__":
    ...
    # # should be 54,364
    # # infobox_text = clean_text(get_first_infobox_text(get_page_html("Saturn")))
    # # print(infobox_text)
    ...
    print("\n<<<<<<<<<<<<<< Testing Birth Dates >>>>>>>>>>>>>>")
    # infobox_text = clean_text(get_first_infobox_text(get_page_html("Alan Turing")))
    # print(infobox_text)
